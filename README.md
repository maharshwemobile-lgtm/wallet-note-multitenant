...
**Admin passcode ဆိုတာ မရှိပါဘူး။** ဘာမှ ရိုက်ထည့်စရာ မလိုပါ။ ရှေ့က
`ADMIN_SECRET` header စနစ်ကို လုံးဝ ဖျက်လိုက်ပါပြီ။

စာမျက်နှာဖွင့်လိုက်တာနဲ့ **ကိန်းဂဏန်းများ ချက်ခြင်း ပေါ်ပါတယ်** — Login
ဝင်စရာ မလိုပါဘူး။ Account ဘယ်နှစ်ခုရှိလဲဆိုတာက ဒီ Service အကြောင်း
အချက်အလက်ဖြစ်ပြီး ဘယ်သူ့အကြောင်းမှ မဖော်ပြပါဘူး။

ဒါပေမဲ့ **အသုံးပြုသူစာရင်းနှင့် Activity မှတ်တမ်း** ကတော့ Login ဝင်ထားတဲ့
Admin အတွက်သာ ပြပါတယ်။ အဲဒီစာရင်းတွေမှာ တခြား Business ၂၃၀ ကျော်ရဲ့
နာမည်၊ ဝန်ထမ်းများရဲ့ နာမည်နှင့် username၊ သူတို့ ဘာလုပ်ခဲ့လဲဆိုတာတွေ
ပါဝင်ပါတယ်။ အဲဒါတွေက တခြားလူတွေရဲ့ Data ဖြစ်ပြီး ကျွန်ုပ်တို့ရဲ့
Privacy Policy မှာလည်း မမျှဝေဘူးလို့ ကြေညာထားပါတယ်။

Admin အဖြစ် ဝင်ခွင့်ရှိသူများကို `ADMIN_USERS` environment variable ထဲမှာ
username သို့မဟုတ် email နဲ့ စာရင်းပြုစုပါ (comma ခြားပါ):

```
ADMIN_USERS=khunmyintaung,khunmyintaung@gmail.com
```

မသတ်မှတ်ထားရင် စာရင်းအသေးစိတ်ကို ဘယ်သူမှ မမြင်ရပါဘူး (ကိန်းဂဏန်းများ
ကတော့ ပေါ်နေမှာပါ)။
