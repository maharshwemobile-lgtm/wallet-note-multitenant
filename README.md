...
စာမျက်နှာဖွင့်လိုက်တာနဲ့ **ကိန်းဂဏန်းများနှင့် Activity Log ချက်ခြင်း
ပေါ်ပါတယ်** — Login ဝင်စရာ မလိုပါဘူး။ ဘယ်အချိန် ဘာလုပ်ဆောင်ချက် ဖြစ်ခဲ့လဲ
ဆိုတာ လူတိုင်း ကြည့်နိုင်ပါတယ်။

ဒါပေမဲ့ **ဘယ်လုပ်ငန်း၊ ဘယ်သူ** ဆိုတဲ့ နာမည်များကတော့ Login ဝင်ထားတဲ့
Admin အတွက်သာ ပြပါတယ်။ Server ကနေ တင်ကတည်းက နာမည်တွေ မထည့်လိုက်တာပါ —
စာမျက်နှာက ဖျောက်ထားတာ မဟုတ်ပါဘူး။ အဲဒါတွေက တခြားလုပ်ငန်း ၂၃၀ ကျော်နဲ့
သူတို့ဝန်ထမ်းများရဲ့ Data ဖြစ်ပြီး၊ ကျွန်ုပ်တို့ရဲ့ Privacy Policy မှာ
မမျှဝေဘူးလို့ ကြေညာထားပါတယ်။
